namespace Nutanix.Powershell.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="UserIntentResponse" />
    /// </summary>
    public class UserIntentResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="UserIntentResponse"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="UserIntentResponse" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="UserIntentResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="UserIntentResponse" />.</param>
        /// <returns>
        /// an instance of <see cref="UserIntentResponse" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                UserIntentResponse.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new UserIntentResponse
                {
                ApiVersion = sourceValue.ApiVersion,
                Metadata = UserMetadataTypeConverter.ConvertFrom(sourceValue.Metadata),
                Spec = UserTypeConverter.ConvertFrom(sourceValue.Spec),
                Status = UserDefStatusTypeConverter.ConvertFrom(sourceValue.Status),
                };
            }
            catch
            {
