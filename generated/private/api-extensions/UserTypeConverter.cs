namespace Nutanix.Powershell.Models
{
    ...
    /// </summary>
    public class UserTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                User.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new User
                {
                Resources = UserInputResourceTypeConverter.ConvertFrom(sourceValue.Resources),
                };
            }
            catch
            {
