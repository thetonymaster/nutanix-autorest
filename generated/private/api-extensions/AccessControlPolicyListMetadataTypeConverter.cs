namespace Nutanix.Powershell.Models
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="AccessControlPolicyListMetadata" />
    /// </summary>
    public class AccessControlPolicyListMetadataTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="AccessControlPolicyListMetadata"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="AccessControlPolicyListMetadata" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="AccessControlPolicyListMetadata" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="AccessControlPolicyListMetadata" />.</param>
        /// <returns>
        /// an instance of <see cref="AccessControlPolicyListMetadata" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                AccessControlPolicyListMetadata.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new AccessControlPolicyListMetadata
                {
                Filter = sourceValue.Filter,
                Kind = sourceValue.Kind,
                Length = sourceValue.Length,
                Offset = sourceValue.Offset,
                SortAttribute = sourceValue.SortAttribute,
                };
            }
            catch
            {
