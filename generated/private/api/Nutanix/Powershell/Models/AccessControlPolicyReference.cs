namespace Nutanix.Powershell.Models
{
    ...
    public partial class AccessControlPolicyReference : Nutanix.Powershell.Models.IAccessControlPolicyReference, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        /// <summary>Creates an new <see cref="AccessControlPolicyReference" /> instance.</summary>
        public AccessControlPolicyReference()
        {
        }
    ...
    public partial interface IAccessControlPolicyReference : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        string Kind { get;  }
        string Name { get;  }
        string Uuid { get; set; }
    }
