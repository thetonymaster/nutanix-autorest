namespace Nutanix.Powershell.Models
{
    ...
    public partial class UserIntentResponse
    {
        ...
        /// <summary>
        /// Serializes this instance of <see cref="UserIntentResponse" /> into a <see cref="Carbon.Json.JsonNode" />.
        /// </summary>
        /// <param name="container">The <see cref="Carbon.Json.JsonObject"/> container to serialize this object into. If the caller
        /// passes in <c>null</c>, a new instance will be created and returned to the caller.</param>
        /// <param name="serializationMode">Allows the caller to choose the depth of the serialization. See <see cref="Microsoft.Rest.ClientRuntime.SerializationMode"/>.</param>
        /// <returns>
        /// a serialized instance of <see cref="UserIntentResponse" /> as a <see cref="Carbon.Json.JsonNode" />.
        /// </returns>
        ...
        /// <summary>
        /// Deserializes a Carbon.Json.JsonObject into a new instance of <see cref="UserIntentResponse" />.
        /// </summary>
        /// <param name="json">A Carbon.Json.JsonObject instance to deserialize from.</param>
        internal UserIntentResponse(Carbon.Json.JsonObject json)
        {
            bool returnNow = false;
